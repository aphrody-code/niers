...
pub static REGLES: &[Regle] = &[
    ...
    r!("inacord-vfs-navmesh", Inacord, Motif::Exact("vfs_apercu_navmesh"), manquant("nie_formats::navm — parseur NAVM validé sur les 160 `.g4nv`")),
    ...
    r!("formats-lip", NieFormats, Motif::Exact("lip"), manquant("crates/engine/nie-formats/src/lip.rs — 21 047 `.p3lip`, parseur écrit, aucune route")),
    r!("formats-navm", NieFormats, Motif::Exact("navm"), manquant("crates/engine/nie-formats/src/navm.rs — NAVM validé, 160 `.g4nv`")),
    r!("formats-g4la", NieFormats, Motif::Exact("g4la"), manquant("crates/engine/nie-formats/src/g4la.rs — validé byte sur les 4 fichiers réels")),
    r!("formats-g4vs", NieFormats, Motif::Exact("g4vs"), manquant("crates/engine/nie-formats/src/g4vs.rs — validé byte sur les 4 fichiers réels")),
    r!("formats-g4ma", NieFormats, Motif::Exact("g4ma"), manquant("crates/engine/nie-formats/src/g4ma.rs — validé byte sur les 35 fichiers réels")),
    ...
    r!("vfs-p3lip", Vfs, Motif::Exact(".p3lip"), manquant("nie_formats::lip — pistes de lip-sync, parseur écrit, aucune route")),
    r!("vfs-g4nv", Vfs, Motif::Exact(".g4nv"), manquant("nie_formats::navm — navmesh NAVM, parseur validé")),
    r!("vfs-g4ma", Vfs, Motif::Exact(".g4ma"), manquant("nie_formats::g4ma — animation de matériau, validée byte")),
    r!("vfs-g4vs", Vfs, Motif::Exact(".g4vs"), manquant("nie_formats::g4vs — effet d'événement, validé byte")),
    r!("vfs-g4la", Vfs, Motif::Exact(".g4la"), manquant("nie_formats::g4la — animation de lumière, validée byte")),
