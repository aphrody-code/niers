...
const unifiedPlanContent = `# UNIFIED-PLAN.md — Master Execution Plan & Operational Roadmap
...
writeFileSync("docs/UNIFIED-PLAN.md", unifiedPlanContent, "utf-8");
console.log("Wrote docs/UNIFIED-PLAN.md");
