...
| **Le cap** | **`docs/PLAN-SITE-ULTIME.md`** — couverture de TOUTE la surface du dépôt, gate `manquant = 0` |
| La hiérarchie des plans | `docs/README.md` § « La direction » — quel plan commande lequel |
